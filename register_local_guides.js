...
if (!scriptContent.includes('car-accident-toronto-guide.html')) {
  scriptContent = scriptContent.replace('const ARTICLES = [', 'const ARTICLES = [\n' + newArticles);
  fs.writeFileSync(scriptPath, scriptContent, 'utf8');
  console.log('Registered 5 local guides in script.js');
} else {
  console.log('Guides already registered.');
}
